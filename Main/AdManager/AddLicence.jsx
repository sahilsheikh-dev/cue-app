...
import styles from "./AddLicenceCss";
...
export default function AddLicence({ navigation, route }) {
        ...
        <>
          ...
          <ScrollView style={styles.main_scroll_view}>
                ...
                <View style={styles.indi_up_inner}>
                  {img1 == "" ? (
                    <>
                      ...
                      <Text style={styles.upy_text}>Upload a permit</Text>
                      <Text style={styles.mpp_text}>
                        It could be a license, or a permission grant, depending
                        on local laws requirements.
                      </Text>
                    </>
                  ) : (
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                navigation.navigate("Ad-agreement", {
                  img: img,
