      ...
      <ScrollView style={styles.main_scroll_view}>
        ...
        <View style={styles.back_section}>
          ...
          <View style={styles.bs_2}>
            <Text style={styles.bs_2_cue}>Ad Manager</Text>
          </View>
        ...
        <View style={styles.options_double}>
          <TouchableOpacity
            ...
            onPress={() => {
              navigation.navigate("Ad-create-ad");
            }}
          >
            <LinearGradient
            ...
            >
              ...
              >
                <Text style={styles.ioc_text}>Create</Text>
              </LinearGradient>
            </LinearGradient>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.indi_option_sq}
            onPress={() => {
              navigation.navigate("Track-manage");
            }}
          >
            <LinearGradient
              style={styles.indi_option_circle}
            ...
            >
              <LinearGradient
                ...
                colors={["rgba(255, 255, 255, 0.1)", "rgba(30, 53, 126, 0)"]}
              >
                <Text style={styles.ioc_text}>Track</Text>
              </LinearGradient>
            </LinearGradient>
          </TouchableOpacity>
        </View>
          ...
          >
            ...
            >
              <LinearGradient
                ...
                colors={["rgba(255, 255, 255, 0.1)", "rgba(30, 53, 126, 0)"]}
              >
                <Text style={styles.ioc_text}>Manage</Text>
              </LinearGradient>
            </LinearGradient>
          </TouchableOpacity>
          <TouchableOpacity
