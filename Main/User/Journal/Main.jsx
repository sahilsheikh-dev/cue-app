...
export default function MainJournal({ navigation, route }) {
  ...
  useEffect(() => {
    if (!isFocused) return;
    axios
      .post(data.url + "/user/get-journal", {
        type: type,
          ...
          {journal.map((item) => {
            ...
            return (
              ...
              >
                ...
                >
                  <Text style={styles.indi_journal_title} numberOfLines={2}>
                    {item.title}
                  </Text>
                  <Text style={styles.indi_journal_des} numberOfLines={4}>
                  ...
                  >
                    <View style={styles.j_options}>
                      {item.cue.map((item, index) => {
                        if (index <= 1) {
                          return (
                            <View style={styles.j_option_indi}>
                              <Text style={styles.j_options_indi_text}>
                                Ideas
                              </Text>
                            </View>
                          );
                    ...
                    <View style={styles.indi_option_date_section}>
                      <Text style={styles.indi_option_date_text}>
                        {item.date_of_creation.split("T")[0].split("-")[2] +
                          "-" +
                          item.date_of_creation.split("T")[0].split("-")[1] +
                          "-" +
                          item.date_of_creation.split("T")[0].split("-")[0]}
                      </Text>
                    </View>
                  </View>
                </LinearGradient>
