...
export default function IndiEvents({ navigation, route }) {
  ...
  useEffect(() => {
    axios
      .post(data.url + "/user/get-event-info", {
          ...
          >
            ...
            >
              <View style={styles.indi_event_img_section}>
                <Image
                  source={{
                    uri: data.url + "/creative/" + event_info.event_banner,
                  }}
                  style={styles.ie_img}
                />
              </View>
              <View style={styles.indi_events_bottom}>
                <View style={styles.ie_left}>
                  <View style={styles.ie_left_event_name_view}>
                    ...
                    <Text style={styles.hosted_by}>
                      Hosted by {event_info.event_host}
                    </Text>
                  </View>
                  <View style={styles.ie_time_section}>
                    ...
                    <View>
                      <Text style={styles.event_time}>
                        {event_info.event_time_from} -{" "}
                        {event_info.event_time_to}
                      </Text>
                    </View>
                  </View>
                  <View style={styles.ie_time_section}>
                    <View>
                      ...
                      >
                        <Path
                          fill-rule="evenodd"
                          clip-rule="evenodd"
                          d="M6.12109 10.645L7.18288 7.25221L10.5757 6.19043L9.51392 9.58326L6.12109 10.645Z"
                          stroke="white"
                          stroke-linecap="round"
                          stroke-linejoin="round"
                        />
                  ...
                  event_info.event_location == undefined ||
                  event_info.event_location == null ? null : (
                    <View style={styles.ie_time_section}>
                      <View>
                        <Svg
                          width="20"
                ...
                <View style={styles.ie_right}>
                  <View style={styles.event_date_section}>
                    <Text style={styles.event_date}>
                      {event_info.event_date.split("-")[0]}
                    </Text>
                    <Text style={styles.event_date}>
                      {(() => {
                        let month = event_info.event_date.split("-")[1];
                        switch (month) {
                          case "01":
                            return "JAN";
                          case "02":
              ...
              <View style={styles.about_the_workshop_section}>
                ...
                <Text style={styles.atw_des}>{event_info.description}</Text>
              </View>
              <View style={styles.about_the_workshop_section}>
                <Text style={styles.atw_title}>Rules:</Text>
                {event_info.rules.map((item) => {
                  return (
              ...
              <View style={styles.about_the_workshop_section}>
                <Text style={styles.atw_title}>Special Note</Text>
                <Text style={styles.atw_des}>{event_info.special_note}</Text>
              </View>
            </ScrollView>
          </LinearGradient>
          <TouchableOpacity>
            ...
            >
              <Text style={styles.bn_text}>Chat and Book</Text>
            </LinearGradient>
          </TouchableOpacity>
        </View>
      )}
