...
export default function MainOptionsAwareness({ navigation }) {
  ...
  useEffect(() => {
    axios
      .post(data.url + "/user/get-awareness")
      .then((res) => {
        if (res.data.alert != undefined) {
          ...
          const sortedSupply = res.data.supply.sort((a, b) =>
            a.title.localeCompare(b.title)
          );

          setAwareness(sortedSupply);
        ...
        <ScrollView style={styles.main_scroll_view}>
          ...
          <View style={styles.back_section}>
            ...
            <View style={styles.bs_2}>
              <Text style={styles.bs_2_cue}>Self-Awareness</Text>
            </View>
