...
import styles from "./BottomTabCss";
import Home from "./Home";
import MainEvents from "./Event/Main";
import MainJournal from "./Journal/Main";
import Srw from "./Journal/Srw";
        ...
        >
          ...
          {state.index == 2 ? (
            ...
            >
              ...
              <View>
                <Text style={styles.tab_indi_text_}>Journal</Text>
              </View>
            </TouchableOpacity>
          ) : (
            <TouchableOpacity
