...
export default function MainEvents({ navigation }) {
  return (
    <SafeAreaView style={styles.sav}>
      ...
      ></LinearGradient>
      <ScrollView style={styles.main_scroll_view} nestedScrollEnabled={true}>
        ...
        <LinearGradient
          style={styles.banner_space_Section}
          colors={["rgba(255, 255, 255, 0.1)", "rgba(22, 45, 109, 0.1)"]}
        >
          <View style={styles.ad_text_section}>
        ...
        <TouchableOpacity style={styles.indi_event}>
          <View style={styles.indi_events_top}>
            <Image
              source={require("../../Images/img4.png")}
              style={styles.indi_event_img}
