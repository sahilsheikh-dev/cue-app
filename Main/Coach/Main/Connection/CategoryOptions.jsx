...
export default function CategoryOptionsConnection({ navigation, route }) {
  ...
  useEffect(() => {
    axios
      .post(data.url + "/coach/get-liked-activities", { token: data.authToken })
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .post(data.url + "/coach/get-category-options-connection", { id: id })
      .then((res) => {
        if (res.data.alert != undefined) {
          Alert.alert(res.data.alert);
        } else if (res.data.logout == true) {
  ...
  const like_activity = (id) => {
    axios
      .post(data.url + "/coach/like-activity", {
  ...
  const dislike_activity = (id) => {
    axios
      .post(data.url + "/coach/dislike-activity", {
        token: data.authToken,
        id: id,
      })
      .then((res) => {
