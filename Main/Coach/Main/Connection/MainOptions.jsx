...
export default function MainOptionsConnection({ navigation }) {
  ...
  useEffect(() => {
    axios
      .post(data.url + "/coach/get-connections")
      .then((res) => {
        ...
        <ScrollView style={styles.main_scroll_view}>
          ...
          <View style={styles.back_section}>
            ...
            <View style={styles.bs_2}>
              <Text style={styles.bs_2_cue}>Coaches</Text>
            </View>
            ...
            if ((index + 1) % 2 == 0) {
              ...
              return (
                <View style={styles.options_double}>
                  {item.title == "Consultants" ? null : (
                    <TouchableOpacity
                      style={styles.indi_option_sq}
                      onPress={() => {
                        navigation.navigate("ConnectionCategoryOptions", {
                          id: item._id,
                          title: item.title,
                        });
                      }}
