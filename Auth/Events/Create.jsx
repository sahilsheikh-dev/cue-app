      ...
      <View style={styles.main_view}>
        ...
        >
          <View style={styles.inner_ibs}>
            <View style={styles.all_img}>
              <Image source={require("./img1.png")} style={styles.img} />
              <Image source={require("./img2.png")} style={styles.img} />
              <Image source={require("./img1.png")} style={styles.img} />
            </View>
            <Text style={styles.ni_text}>
              No image? No worries! Select one from our curated collection.
            </Text>
          </View>
        </LinearGradient>
        <TouchableOpacity
