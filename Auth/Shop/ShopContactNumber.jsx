...
import styles from "./ShopContactNumberCss";
...
export default function ShopContactNumber({ navigation, route }) {
  ...
  const trySignup = () => {
    if (mobileNumber == "") {
      ...
      axios
        .post(data.url + "/product/auth/signup", {
          name: firstName,
        ...
        .then((res) => {
          if (res.data.alert != undefined) {
            ...
            navigation.navigate("Shop-otp", { otpId: res.data.otpId });
          }
