...
import styles from "./AdContactNumberCss";
...
export default function AdContactNumber({ navigation, route }) {
  const {
    eo_type,
    name,
    company_name,
        ...
        axios
          ...
          .then((res) => {
            ...
            if (res.data.alert != undefined) {
              ...
              navigation.navigate("Ad-otp", { otpId: res.data.otpId });
            }
          })
          .catch((err) => {
            console.log(err);
