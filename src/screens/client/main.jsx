...
export default function Main() {
  return (
      <Stack.Navigator screenOptions={{ headerShown: true }}>
        ...
        <Stack.Screen name="Chat" component={DummyScreen} />
        ...
        <Stack.Screen name="connection-chat" component={DummyScreen} />
        ...
        <Stack.Screen name="AppTermsandCondition" component={DummyScreen} />
        ...
        <Stack.Screen name="ManagemenetChat" component={DummyScreen} />
      </Stack.Navigator>
  );
}
