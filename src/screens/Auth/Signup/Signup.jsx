      ...
      if (password.length < 8) {
        ...
        if (password == confirmPassword) {
          if (agree_tc == false) {
            ...
            switch (role) {
              case "user":
                if (validateInputs(firstName, lastName, password, confirmPassword, role)) {
              ...
              case "coach":
                ...
                break;
              case "ad":
                if (validateInputs(eo_type)) {
                  if (eo_type == "company") {
                    if (validateInputs(company_name, account_operator_name)) {
                    ...
                    if (validateInputs(firstName, lastName, password)) {
                      if (Object.keys(selected_country).length == 0) {
                        Alert.alert("Warning", "Please fill all the details");
                      } else {
                        navigation.navigate("Ad-contact-number", {
              ...
              case "Product Company":
                ...
                if (validateInputs(firstName, password, confirmPassword, role)) {
                  if (Object.keys(selected_country).length == 0) {
                    Alert.alert("Warning", "Please fill all the fields");
                  } else {
